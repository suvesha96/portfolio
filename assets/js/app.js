  ...
  <footer class="footer">
    <div class="container p-4">
      <div class="row">
          ...
          <img src="./assets/images/mail.png" width="30" height="30""> suvesha@uw.edu
          </p>
            ...
            <div class="rounded-social-buttons tag style="position:relative top:100px;">
              ...
              <a class="social-button envelope" href="mailto:suvesha@uw.edu" title="suvesha@uw.edu" target="_blank"><i class="fa fa-envelope-o"></i></a>
            </div>
        </div>
      </div>
    </div>
